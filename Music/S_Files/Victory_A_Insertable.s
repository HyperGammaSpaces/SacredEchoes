...
Victory_A_Insertable_0:
        .byte   KEYSH , Victory_A_Insertable_key+0
@ 000   ----------------------------------------
        .byte   TEMPO , 114/2
Victory_A_Insertable_0_LOOP:
        .byte           VOICE , 48
        .byte           PAN   , c_v-18
        .byte           VOL   , 56
        .byte           N19   , Ds3 , v120
...
@ 021   ----------------------------------------
        .byte           VOICE , 48
        .byte   GOTO
         .word  Victory_A_Insertable_0_LOOP
        .byte   FINE
...
@ 021   ----------------------------------------
        .byte   GOTO
         .word  Victory_A_Insertable_1_LOOP
        .byte   FINE
...
@ 021   ----------------------------------------
        .byte           VOICE , 61
        .byte   GOTO
         .word  Victory_A_Insertable_2_LOOP
        .byte   FINE
...
@ 021   ----------------------------------------
        ...
        .byte           PAN   , c_v-33
        .byte   GOTO
         .word  Victory_A_Insertable_3_LOOP
        .byte   FINE
...
@ 021   ----------------------------------------
        ...
        .byte           PAN   , c_v+0
        .byte   GOTO
         .word  Victory_A_Insertable_4_LOOP
        .byte   FINE
...
@ 021   ----------------------------------------
        ...
        .byte           PAN   , c_v-30
        .byte   GOTO
         .word  Victory_A_Insertable_5_LOOP
        .byte   FINE
...
@ 003   ----------------------------------------
        .byte   PATT
         .word  Victory_A_Insertable_6_1
@ 004   ----------------------------------------
        .byte   PATT
         .word  Victory_A_Insertable_6_2
@ 005   ----------------------------------------
        .byte   PATT
         .word  Victory_A_Insertable_6_1
@ 006   ----------------------------------------
...
@ 021   ----------------------------------------
        ...
        .byte           PAN   , c_v+42
        .byte   GOTO
         .word  Victory_A_Insertable_6_LOOP
        .byte   FINE
...
@ 003   ----------------------------------------
        .byte   PATT
         .word  Victory_A_Insertable_7_1
@ 004   ----------------------------------------
        .byte   PATT
         .word  Victory_A_Insertable_7_2
@ 005   ----------------------------------------
        .byte   PATT
         .word  Victory_A_Insertable_7_1
@ 006   ----------------------------------------
...
@ 017   ----------------------------------------
        .byte   PATT
         .word  Victory_A_Insertable_7_15
@ 018   ----------------------------------------
        .byte           N19   , Dn1 , v117
        .byte   W24
        .byte           N06   , Cs1 , v104
...
@ 021   ----------------------------------------
        .byte   GOTO
         .word  Victory_A_Insertable_7_LOOP
        .byte   FINE

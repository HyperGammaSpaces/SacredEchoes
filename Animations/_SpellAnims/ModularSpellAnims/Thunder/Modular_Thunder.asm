...
ThunderAnim_BG_Init:
	spell_bg_load Thunder_BG1Proc, Thunder_BG1FrameData, Thunder_BG1ImagePointer, Thunder_MeleeTSA, Thunder_RangeTSA, NoPalette, NoPalette, WriteImageMap
	.align
	.ltorg
...
ThunderAnim_PaletteFX_Loop:
	spell_palette_fx_loop Bool_ClearPaletteFx, Bool_LoopForFrameDataLength
	.align
	.ltorg

...
MS_SaveExpandedWMData:
	...
	mov 	r1, sp
	add 	r1, #0x23 			@skirmish array sram start offset
	mov 	r0, r4
	blh 	0x080A7034			@vanilla SaveWMSkirmishData
	mov 	r0, r4
	add 	r0, #0xcc
	ldrb 	r1, [r0, #0x0]
	add 	r0, sp, #0x28		@byte 0xCC is saved to this offset
	strb 	r1, [r0, #0x0]
	mov 	r1, sp
	mov 	r7, #0x20			@cursor data offset
	ldrh 	r0, [r4, #0x2]

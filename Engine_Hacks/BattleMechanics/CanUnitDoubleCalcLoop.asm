...
.global IsCloseCounter
.type IsCloseCounter, %function
...
add r0,#0x4A
ldrh r0,[r0]
ldr r1,=Get_Weapon_Type
mov r14,r1
.short 0xF800
cmp r0,#0x3
bne IsCloseCounter_RetNoChange

IsCloseCounter_CheckRange:
ldrb r0, [ r4, #0x10 ]
ldrb r1, [ r5, #0x10 ]
ldrb r2, [ r4, #0x11 ]
ldrb r3, [ r5, #0x11 ]
...
sub r2, r3
cmp r0, #0x00
bge IsCloseCounter_NotNeg1
	neg r0, r0
IsCloseCounter_NotNeg1:
cmp r2, #0x00
bge IsCloseCounter_NotNeg2
	neg r2, r2
IsCloseCounter_NotNeg2:
add r0, r2 @ Distance between the two units in r0.
cmp r0, #0x01
beq IsCloseCounter_RetFalse

IsCloseCounter_RetNoChange:
mov r0,#2
b IsCloseCounter_GoBack

IsCloseCounter_RetFalse:
mov r0,#0

IsCloseCounter_GoBack:
pop {r4-r5}
pop {r1}
bx r1

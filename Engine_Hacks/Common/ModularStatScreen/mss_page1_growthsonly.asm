...
.set SS_RatingText, SS_TalkText+4
.set Display_Growths_options, SS_RatingText+4
.set Growth_Getters_Table, Display_Growths_options+4
.set Get_Palette_Index, Growth_Getters_Table+4
.set IsUnitEligibleToPromote, Get_Palette_Index+4
...
.set ss_ratingloc, (SS_RatingText - . - 6)
  ldr r0, =ss_ratingloc
  add r0, pc
  ldr r0, [r0]

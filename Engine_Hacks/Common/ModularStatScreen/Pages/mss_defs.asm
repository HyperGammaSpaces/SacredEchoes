...
.equ Draw2SpecialUiChars, 0x08004D5C
...
@ Special font glyphs
@ 0x0 through 0x9 are numerals 
@ 0xA through 0x13 are small numerals
.equ glyph_minus,    0x14
.equ glyph_plus,     0x15
.equ glyph_slash,    0x16
.equ glyph_tilde,    0x17
.equ glyph_S,        0x18
.equ glyph_A,        0x19
.equ glyph_B,        0x1A
.equ glyph_C,        0x1B
...
.equ glyph_G,        0x1E
.equ glyph_K,        0x1F
.equ glyph_colon,    0x20
.equ glyph_fullstop, 0x21
.equ glyph_H,        0x22
.equ glyph_P,        0x23
.equ glyph_L,        0x24
.equ glyph_V,        0x25
.equ glyph_arrowR,   0x26
.equ glyph_heart,    0x27
.equ glyph_100tens,  0x28 @first half of "100"
.equ glyph_100ones,  0x29 @last half of "100"
.equ glyph_percent,  0x2A
.equ glyph_Ec_small, 0x2B
.equ glyph_Ec_dot,   0x2C @more to the left than 0x21
.equ glyph_mo_1,     0x2D
.equ glyph_mo_2,     0x2E
.equ glyph_m_lc,     0x2F @lowercase, similar to 0x2D
.equ glyph_N,        0x30
.equ glyph_Liv_1,    0x31 @cut off on right side to fit 0x32
.equ glyph_Liv_2,    0x32
.equ glyph_v_lc,     0x33 @lowercase
.equ glyph_E_dot,    0x34 @narrow E with .
.equ glyph_E_equip,  0x35
.equ glyph_A_equip,  0x36
.equ glyph_MHP_1,    0x37
.equ glyph_MHP_2,    0x38
@ past here is invalid, add your own!
...
.macro page_start
  ...
  ldr     r0, [r2, #0xC]
  mov     r8, r0              @r8 contains the current
  ldr     r0, =gBg0MapBuffer
  mov     r9, r0              @r9 contains the bg map buffer
.endm
...
.macro draw_glyph_at, tile_x, tile_y, glyph
...
.macro draw_2glyphs_at, tile_x, tile_y, glyph1, glyph2
  ldr     r0, =(0x20*2*\tile_y)+(2*\tile_x) @#0x3C2
  add     r0, r9
  mov     r1, #3
  mov     r2, #\glyph1
  mov     r3, #\glyph2
  blh     Draw2SpecialUiChars
.endm

.macro draw_lv_icon_at, tile_x, tile_y
  draw_2glyphs_at \tileX, \tileY, glyph_L, glyph_V
.endm

.macro draw_exp_icon_at, tile_x, tile_y
  draw_glyph_at \tileX, \tileY, glyph_E
.endm

.macro draw_hp_icon_at, tile_x, tile_y
  draw_2glyphs_at \tileX, \tileY, glyph_H, glyph_P
.endm

.macro draw_ui_slash_at, tile_x, tile_y
  draw_glyph_at \tileX, \tileY, glyph_slash
.endm

.macro draw_level_at, tile_x, tile_y
  ldr     r0, =(0x20*2*\tile_y)+(2*\tile_x) @#0xF2
  add     r0, r9
  mov     r1, r8          @unit pointer
  mov     r2, #8
  ldrb    r2, [r1, r2]    @level
  mov     r1, #2
  blh     DrawDecNumber
...
.macro get_statscreen_allegiance
  ldr     r2, =0x202bcc4
  ldrh    r0, [r2] @xcoord
  ldrh    r1, [r2, #2] @ycoord
...
.macro draw_left_icon_at, tileX, tileY, number=0
  @assumes icon number in r0 or else in number
  .if \number
    mov     r0, #\number
  .endif
...
.macro draw_promotion_icon_at, tileX, tileY, number=0xAD
  get_statscreen_allegiance
  mov     r1, #0xc0         @only check allied units
  and     r1, r0
  cmp     r1, #0
  bne     DontDrawPromoIcon
  mov     r2, r8
  ldr     r0, [r2, #0x0]
  ldrb    r0, [r0, #0x4]
  ...
  blh     IsUnitEligibleToPromote @in GaidenPromotionMechanics
  cmp     r0, #0x0
  beq     DontDrawPromoIcon
  mov     r0, #\number
  mov     r1, r0

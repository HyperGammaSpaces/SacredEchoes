...
strb	r0,[r5,r6]
NoZeroHPHeal:
mov     r0,#0x2E 			@check if defender is done    
ldsh    r1,[r5,r0]           
mov 	r2, #0x50    
ldrsh   r0,[r5,r2]                
cmp     r1,r0               @ Current HP = Final HP?
bne 	CheckStopFlags
mov 	r2, #0x30 			@curr hp - also check if attacker's HP is done
ldsh 	r1, [r5,r2]
...
bne     loc_0x805244E       @ 08052412 D11C  
  ...
  bne     loc_0x805244E     @ 08052420 D115 - frame count?
	...
	@@@@@@@@@@@@@@@@@@@need to stop if atkr AND dfdr are max
	...
	bne 	loc_0x805244E
		...
		bne loc_0x805244E
			cmp r0, #0xff
			bne loc_0x805244E
				mov     r0,#0x1			@ set bit to stop looping   
